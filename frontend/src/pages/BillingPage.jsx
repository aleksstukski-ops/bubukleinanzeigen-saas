...
const PLANS = [
  {
    ...
    period: "",
    accounts: 1,
    features: ["1 Verkaufskonto", "Inserate & Nachrichten verwalten"],
    cta: null,
    highlight: false,
  },
  {
    ...
    period: "/Monat",
    accounts: 1,
    features: ["1 Verkaufskonto", "Inserate & Nachrichten verwalten", "Prioritäts-Support"],
  ...
  },
  {
    ...
    period: "/Monat",
    accounts: 3,
    features: ["3 Verkaufskonten", "Alle Starter-Features", "Bulk-Aktionen"],
    cta: "Upgrade auf Pro",
    highlight: true,
  },
  {
    ...
    period: "/Monat",
    accounts: 10,
    features: ["10 Verkaufskonten", "Alle Pro-Features", "Dedizierter Support"],
